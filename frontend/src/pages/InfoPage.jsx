...
export default function InfoPage() {
  ...
  return (
    <div className="min-h-screen bg-primary">
      {/* Hero */}
      <section className="bg-primary-light py-16 text-white sm:py-24">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-2xl font-bold text-text-dark">Notre histoire</h2>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
            <div className="rounded-2xl border border-border bg-surface p-6">
              <h3 className="text-xl font-bold text-text-dark">🎯 Notre mission</h3>
            ...
            <div className="rounded-2xl border border-border bg-surface p-6">
              <h3 className="text-xl font-bold text-text-dark">🔭 Notre vision</h3>
              <p className="mt-3 text-base leading-7 text-text-muted">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-2xl font-bold text-text-dark">Nos valeurs</h2>
          <div className="mt-6 space-y-6">
            <div className="rounded-xl border border-border bg-surface p-5">
              <h4 className="font-bold text-text-dark">Qualité irréprochable</h4>
            ...
            <div className="rounded-xl border border-border bg-surface p-5">
              <h4 className="font-bold text-text-dark">Délais tenus</h4>
              <p className="mt-1 text-sm text-text-muted">
            ...
            <div className="rounded-xl border border-border bg-surface p-5">
              <h4 className="font-bold text-text-dark">Accompagnement humain</h4>
              <p className="mt-1 text-sm text-text-muted">
            ...
            <div className="rounded-xl border border-border bg-surface p-5">
              <h4 className="font-bold text-text-dark">Prix justes et clairs</h4>
              <p className="mt-1 text-sm text-text-muted">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 text-center sm:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-sm text-white/60">Commandes réalisées</p>
            </div>
            <div>
              <p className="text-4xl font-extrabold text-gold">98 %</p>
              <p className="mt-2 text-sm text-white/60">Clients satisfaits</p>
            </div>
            <div>
              <p className="text-4xl font-extrabold text-gold">24 h</p>
              <p className="mt-2 text-sm text-white/60">Délai moyen de réponse</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-text-dark">Prêt à concrétiser votre projet ?</h2>
